...
RSpec.describe 'Api::V1::Carts', type: :request do
  ...
  describe 'POST /api/v1/cart/add_item' do
    ...
    it 'adiciona item com sucesso' do
      expect(add_item_service).to receive(:call).with(client_id: '1', product_id: '10', quantity: '2',
                                                      cart: cart_mock).and_return(cart_mock)
  ...
  describe 'PATCH /api/v1/cart/update_status_in_progress_orders' do
    ...
    it 'atualiza status com sucesso' do
      expect(update_status_service).to receive(:call).with(cart_id: '1',
                                                           new_status: 'em_preparação').and_return(cart_mock)
